...
public class Calculator_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_uh00px_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_uh00px_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_uh00px_d0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_uh00px_e0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_uh00px_c0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Calculator_Editor.inputFieldListHandler_uh00px_c0(node, "inputField", editorContext);
  ...
  private static class inputFieldListHandler_uh00px_c0 extends RefNodeListHandler {
    public inputFieldListHandler_uh00px_c0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_uh00px_d0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNodeList_uh00px_e0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Calculator_Editor.outputFieldListHandler_uh00px_e0(node, "outputField", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class outputFieldListHandler_uh00px_e0 extends RefNodeListHandler {
    public outputFieldListHandler_uh00px_e0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
    public SNode createNodeToInsert(EditorContext editorContext) {
      SNode listOwner = super.getOwner();
