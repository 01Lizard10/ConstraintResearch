...
public class Input_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_z9sdep_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_z9sdep_c0(editorContext, node));
  ...
  private EditorCell createProperty_z9sdep_c0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
