...
public class Button_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_78mff1_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_78mff1_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_78mff1_d0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_78mff1_c0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
  ...
  private EditorCell createConstant_78mff1_d0(EditorContext editorContext, SNode node) {
